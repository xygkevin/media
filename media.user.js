...
// @updateURL         https://raw.githubusercontent.com/syhyz1990/media/master/media.user.js
// @downloadURL       https://raw.githubusercontent.com/syhyz1990/media/master/media.user.js
  ...
  let main = {
    showButton: function () {
      if (location.host.match(/youku|iqiyi|le|qq|tudou|mgtv|sohu|acfun|bilibili|pptv|baofeng/ig)) {
        ...
        //反馈按钮
        $('.h-ol').append(`<li><a target="_blank" style="color: #999;" href="https://github.com/syhyz1990/media/issues">失效反馈</a></li>`);
